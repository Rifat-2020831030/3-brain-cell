...
return (
    <div className="flex flex-col md:flex-row">
        ...
        <div className="flex flex-wrap justify-center">
                ...
                {ongoingDisaster.map((disaster, index) => (
                    ...
                    >
                        <div className="mt-25 bg-gradient-to-b from-transparent to-black bg-opacity-70 p-4 rounded-lg h-full flex flex-col justify-between">
                            <div>
                                <h2 className="text-xl text-white text-wrap font-bold mb-2">{disaster.title}</h2>
                                <p className="mb-2 text-gray-200"><strong>Location:</strong> {disaster.location}</p>
            ...
            {step === 2 && <TeamCard initialTeams={initialTeams} handleNext={handleNext} />}
